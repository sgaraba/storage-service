...
public class UserFilesExcel {

    static String[] HEADERs = { "Id", "Name", "Size", "Mime Type", "Path", "Created By", "Created Date" };
    static String SHEET = "Files";

    public static ByteArrayInputStream userFilesToExcel(List<StorageFile> storageFiles) {
