...
To build the final jar and optimize the storageService application for production, run:
...
Unit tests are run by [Jest][]. They're located in [src/test/javascript/](src/CsvService/javascript/) and can be run with:
